import { Award, Coins, LayoutPanelLeft, QrCode, User, LogOut } from "lucide-react";
    ...
    return (
        <div className="min-h-screen md:max-w-6xl p-4 mx-auto">
            ...
            <div className="flex md:flex-row flex-col-reverse">
                            ...
                            <li key={tab.id} className="mb-5 md:mb-5">
                                <Link
                                    ...
                                    className={`flex items-center gap-2 p-2 rounded-sm ${
                                        location.pathname === tab.link ? "bg-green-500 text-white" : "hover:bg-gray-200"
                                    }`}
                                >
                ...
                {/* Main Content */}
                <div className="flex-1 pb-30">  {/* Added bottom padding */}
