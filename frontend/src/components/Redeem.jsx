...
import { LogOut, Home, Leaf, Award, BarChart2, CreditCard, Gift, ArrowLeft } from 'lucide-react';
import { UserTokenContext } from "../pages/DashboardLayout"; // Import the context
...
const REWARDS = [
  ...
  },
  {
    ...
    description: 'Sturdy tote bag created from recycled plastic',
    tokenCost: 100,
    image: '👜',
    category: 'Products',
  },
  {
    id: 3,
    name: 'Local Café Discount',
    description: '15% off at participating eco-friendly cafés',
    tokenCost: 80,
    image: '☕',
    category: 'Discounts',
  },
  ...
  },
  {
    ...
    description: 'Set of metal straws with cleaning brush',
    tokenCost: 70,
    image: '🥤',
    category: 'Products',
  },
...
const RewardCard = ({ reward, onRedeem, userTokens }) => {
  const canRedeem = userTokens >= reward.tokenCost;
...
const Redeem = () => {
    const { userTokens, setUserTokens } = useContext(UserTokenContext); 
  ...
  const confirmRedeem = () => {
    setUserTokens(userTokens - selectedReward.tokenCost);
